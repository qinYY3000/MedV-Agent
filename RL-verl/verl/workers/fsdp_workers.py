...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        # AutoModelForVision2Seq was renamed to AutoModelForImageTextToText in transformers>=4.46
        ...
        _attn_impl = override_model_config.get("attn_implementation", "flash_attention_2")
        actor_model_config = AutoConfig.from_pretrained(
            local_path, trust_remote_code=trust_remote_code, attn_implementation=_attn_impl
        )
